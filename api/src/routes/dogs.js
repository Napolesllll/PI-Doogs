...
const services = require("../controllers/services_API");
...
router.post("/", async (req, res, next) => {
  ...
  try {
    ...
    let typeTemperament = await Temperament.findAll({ where:{ name: temperaments } })
    dogCreated.addTemperament(typeTemperament) // incluyo el temperamento en el perro creado
    res.status(200).send("Perro Cargado")   
